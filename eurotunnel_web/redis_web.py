...
class RedisInterfaceWeb:
    ...
    LABEL_RECALCULATE: Final[int] = 60 * 60 * 24 * 3 #labels are cached for 3 days , afterwhich point we won't regularly be needing them
    ...
    def get_trainpass_displayname(self, tpid:int) -> Displaynames | None:
        ...
        try:
            ...
            return Displaynames(display_names_dict[RedisInterfaceWeb.LONG_DISP_NAME],display_names_dict[RedisInterfaceWeb.SHORT_DISP_NAME])
