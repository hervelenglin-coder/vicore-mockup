...
from eurotunnel_web.db_iface import get_n_train_passes_before_by_system, get_train_pass_info_with_cars, get_n_train_passes, get_n_train_passes_before
    ...
    if request.method == 'POST':
        if not session.get(USER_DETAILS_SESSION_VAR):
            ...
            if not installation_id:                
                ...
                system = next(system for system in system_endpoints.get_systems()  if system.installation_id == int(installation_id))
